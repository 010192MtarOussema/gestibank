...
public class CompteConverter {
	...
	public static CompteDTO entityToDto(Compte compte) {
		return new CompteDTO(compte.getId(), compte.getNumeroDeCompte(), compte.getRib(), compte.getSolde(),
				compte.getDecouvert(), compte.getMontantAgios(), compte.getMontantRenumeration());
